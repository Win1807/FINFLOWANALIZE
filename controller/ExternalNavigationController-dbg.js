 ...
 return {
  ...
  onTargetObtained: function(oEvent, that) {
   ...
   if ((oParameters.semanticAttributes.noNav && oSource.getText() === "-") ||
    ...
    oParameters.actions = this.provideAdditionalParameter(oAcceptAction, oSelVariant);
  ...
  addMoreNavParameters: function(oParameters, oSelectionVariant, that) {
   ...
   //build date indicator parameter
   oSelectionVariant.addParameter("DateIndicator", that.getView().byId("idDateIndicator").getSelectedKey());
  },
  ...
  provideAdditionalParameter: function(sAction, oSelVariant) {
   var sAccecptAction = [];
   var tempStr = null;
  ...
  setOverduePlanningLevel: function(oParameters, oSelectionVariant, oSource, that) {
   ...
   if (oSourceObject.ViewTypeExt === "2FLOWS" && oSourceObject.PlanningLevel !== undefined) {
    ...
    if (fieldName === 'OverDue') {
     jQuery.each(overduepl, function(index, value){
      if (oSourceObject.PlanningLevel === value.Low) {
     ...
     if (oSelectionVariant.getSelectOption("OverduePlanningLevel") !== undefined) {
      oSelectionVariant.removeSelectOption("OverduePlanningLevel");
      oSelectionVariant.addSelectOption("OverduePlanningLevel", "I", "EQ", oSourceObject.PlanningLevel);
      oSelectionVariant.addSelectOption("OverduePlanningLevel", "E", "EQ", oSourceObject.PlanningLevel);
     } else {
      oSelectionVariant.addSelectOption("OverduePlanningLevel", "I", "EQ", oSourceObject.PlanningLevel);
     }
     ...
     if (oSelectionVariant.getSelectOption("PlanningLevel") !== undefined) {
      oSelectionVariant.removeSelectOption("PlanningLevel");
      oSelectionVariant.addSelectOption("PlanningLevel", "I", "EQ", oSourceObject.PlanningLevel);
      oSelectionVariant.addSelectOption("PlanningLevel", "E", "EQ", oSourceObject.PlanningLevel);
     } else {
      oSelectionVariant.addSelectOption("PlanningLevel", "I", "EQ", oSourceObject.PlanningLevel);
     }
    } else {
   ...
   delete oParameters.semanticAttributes.PlanningLevel;
